...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Pingpong Mobile" => "email@address.com" }
  # Or just: spec.author    = "Pingpong Mobile"
  # spec.authors            = { "Pingpong Mobile" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Pingpong Mobile"
